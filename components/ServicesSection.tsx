...
export function ServicesSection({ onSelectPackage }: ServicesSectionProps) {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      {packages.map((pkg) => (
        <div
          key={pkg.id}
          className={`relative p-6 md:p-8 bg-secondary/30 border border-border rounded transition-all hover:border-accent/50 hover:glow-accent ${
        ...
        >
          ...
          <div className="mb-6">
            <h3 className="text-2xl font-bold mb-2 tracking-tight uppercase font-heading">
              {pkg.name}
            </h3>
